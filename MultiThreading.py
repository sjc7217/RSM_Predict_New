...
if(__name__=="__main__"):
    ...
    th1 = threading.Thread(target=run_one_time_project,args=(LOCK,"PRO1",))
    th2 = threading.Thread(target=run_one_time_project,args=(LOCK,"PRO2",))
    th3 = threading.Thread(target=run_one_time_project,args=(LOCK,"PRO3",))
    th4 = threading.Thread(target=run_one_time_project,args=(LOCK,"PRO4",))
    # 启动线程
    th1.start()
    th2.start()
    th3.start()
