...
para_init_0 = open("./data/output_2_2_new/out_0_0.csv", "r")
...
for x in range(87):
    for y in range(75):
        if ((not os.path.exists("./data/net_saved_30_30_10_4new/net_" + str(x) + "_" + str(y) + ".pkl"))):
            LIST_NUM.append([x, y])
...
def run_one_time_project(x_y):
    try:
        ...
        name = "./data/net_saved_30_30_10_4new/net_" + str(x_y[0]) + "_" + str(x_y[1]) + ".pkl"
        #训练开启代码
        train(name, f)
    except:
